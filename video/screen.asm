...
global Print16, PrintIfConfigBits16, PrintRegs16, ScreenClear16, ScreenScroll16,\
       CursorHome, Print32, PrintIfConfigBits32, PrintRAM32, PrintRegs32,\
	   ScreenClear32, ScreenScroll32, ScreenScroll16
