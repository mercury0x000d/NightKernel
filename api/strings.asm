...
; globals
global StringTokenBinary, StringTokenDecimal, StringTokenHexadecimal,\
	   StringTokenString, ConvertNumberHexToString, StringLength, ConvertStringHexToNumber,\
	   StringCharAppend, StringTruncateLeft, StringTruncateRight, ConvertByteToHexString16,\
	   StringTrimRight
section .data
