...
global CriticalError, IDTInit, InterruptHandlerGet, InterruptHandlerSet,\
	   InterruptUnimplemented, ISRInitAll, 

extern PICIntComplete, TaskSwitch, RTCInterruptHandler,\
	   Print32, KeyWait, TaskKill, ScreenClear32, MemAllocate,\
	   PrintRAM32, StringTokenString, StringTokenHexadecimal, kMaxLines,\
	   StringTokenBinary, PrintRegs32, MemCopy
